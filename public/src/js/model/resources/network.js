        ...
        table.bootstrapTable({
            ...
            columns: [
                [
                    ...
                    {field: 'name', title: "设备" + L('Name'), align: 'left'},
                    {field: 'address', title: "管理" + L('Address'), align: 'left'},
                    {field: 'monitoring_status', title: L('Monitor') + "状态",formatter: Controller.api.formatter.monitor},
                    {field: 'network_type', title: "设备" + L('Type')},
                    {field: 'network_model', title: "设备" + L('Model')},
                    {field: 'region', title: "设备" + L('Position')},
